...
public class IceTower implements ITower, IRenderableSprite {
    ...
    private final Graphic file = Graphic.ICE_TOWER;
     ...
     */
    public IceTower(int life, int damage, int footprint, int cost, int attackSpeed, int attackRange, Coordinate position) {
        this.life = life;
        this.damage = damage;
