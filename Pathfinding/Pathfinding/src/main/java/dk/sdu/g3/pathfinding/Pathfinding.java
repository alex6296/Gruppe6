...
public class Pathfinding implements IPathfinding {
    ...
    private void defineGoalNode(Coordinate goal) { //Rework
        goalNode = null;
        for (Node node : nodes) {
    ...
    private void defineStartNode(Coordinate start) { //Rework
        startNode = null;
        for (Node node : nodes) {
     ...
     */
    private void calculateTotalPathCost(Node node) {
     ...
     */
    private List<Coordinate> convertNodes(List<Node> list) {
